...
data_root = os.path.abspath(os.path.join(script_dir, "..", "Data_Handling_Layer"))
datasets = [
    (os.path.join(data_root, "shape_data"), os.path.join(data_root, "shape-pngs")),
    (os.path.join(data_root, "test_shape_data"), os.path.join(data_root, "test_shape-pngs")),
    (os.path.join(data_root, "text_data"), os.path.join(data_root, "text-pngs")),
